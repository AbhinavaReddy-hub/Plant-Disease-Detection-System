...
export default function NavBar() {
  ...
  useEffect(()=>{
    ...
    if(isDarkMode===true){
      ...
      document.querySelector(".navWraper header").style.backgroundColor  ='rgb(14,188,14)';
      document.querySelector(".aboutUs .lc").style.color='black';
      document.querySelectorAll(".diagnosisPageLink .arrow")[0].style.color="black";
      document.querySelectorAll(".diagnosisPageLink .arrow")[1].style.color="black";
      if(document.querySelector(".weatherContainer")){
      document.querySelector(".weatherContainer").style.backgroundColor="rgb(212, 206, 206)";
      document.querySelector(".weatherContainer .weatherDetail").style.color="black";
      }
